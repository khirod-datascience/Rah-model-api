...
model = load_model('/content/drive/MyDrive/RAH/Checkpoints/nextword_pred.h5')
tokenizer = pickle.load(open('/Users/devdarshanmishra/Desktop/RAH/tokenizer1.pkl', 'rb'))
